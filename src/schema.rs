        ...
        "list" => Some(CommandSchema {
            ...
            output_fields: vec![
                ...
                FieldDef {
                    ...
                    r#type: "string",
                    nullable: false,
                    description: "Recording date (YYYY-MM-DD HH:MM)",
                },
                FieldDef {
                    name: "duration",
                    r#type: "string",
                    nullable: false,
                    description: "Human-readable duration (e.g. 2m05s)",
                },
                FieldDef {
                    name: "duration_secs",
                    r#type: "number",
                ...
                FieldDef {
                    ...
                    r#type: "string",
                    nullable: false,
                    description: "Recording title or location",
                },
                FieldDef {
                    name: "status",
                    r#type: "string",
                    nullable: false,
                    description: "Processing status: pending, done, needs-whisply",
                },
                FieldDef {
                    name: "method",
                    r#type: "string",
                    nullable: true,
                    description: "Transcription method used: tsrp or whisply",
                },
                FieldDef {
                    name: "words",
                    r#type: "integer",
                ...
                FieldDef {
                    ...
                    r#type: "boolean",
                    nullable: false,
                    description: "True if file is iCloud-only (evicted from local storage)",
                },
            ],
        }),
        ...
        "extract" => Some(CommandSchema {
            ...
            output_fields: vec![
                FieldDef {
                    ...
                    r#type: "integer",
                    nullable: false,
                    description: "Number of recordings successfully transcribed",
                },
                FieldDef {
                    name: "skipped",
                    r#type: "integer",
                    nullable: false,
                    description: "Number of recordings skipped",
                },
                FieldDef {
                    name: "evicted",
                    r#type: "integer",
                    nullable: false,
                    description: "Number of iCloud-only recordings skipped",
                },
                FieldDef {
                    name: "needs_whisply",
                    r#type: "integer",
                    nullable: false,
                    description: "Number needing --all for whisply fallback",
                },
                FieldDef {
                    name: "files",
                    r#type: "array",
                    nullable: false,
                    description: "List of extracted files with uuid, title, method, words, file",
                },
            ],
        }),
        _ => None,
